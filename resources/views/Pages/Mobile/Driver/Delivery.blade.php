...
@section('content')
    <div class="content-fluid pb-4">
        <h1 class="text-center mb-4">Today Deliveries</h1>
        @if ($works->isEmpty())
              ...
              <div class="d-flex py-auto justify-content-between ">
                <div>
                  <h5 class="font-weight-bolder mb-0">
                    {{ date('d M Y', strtotime($work->order->deliveryDate->schedule_date)) }}
                  </h5>
                ...
                <div class="dropdown d-inline">
                  ...
                  <ul class="dropdown-menu px-2 py-3" aria-labelledby="more" data-popper-placement="left-start">
                    ...
                    @if ($work->status == 0)
                      <li>
                        <button class="dropdown-item border-radius-md" data-order="{{ $work->order_id }}" data-status="delivering" data-assign="delivery" onclick="updateStats(this)">Deliver Now!</button>
                      </li>
                    @elseif($work->status == 1)
                      <li>
                        <button class="dropdown-item border-radius-md" data-order="{{ $work->order_id }}" data-status="delivered" data-assign="delivery" onclick="uploadPhoto(this,'confirmPhoto', 'takePhoto-{{ $work->order_id }}')">Delivered!</button>
                      </li>
                    @endif
                  </ul>
                </div>
