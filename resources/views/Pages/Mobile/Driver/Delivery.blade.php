              ...
              <div class="d-flex py-auto justify-content-between ">
                ...
                <div class="dropdown d-inline">
                  ...
                  <ul class="dropdown-menu px-2 py-3" aria-labelledby="more" data-popper-placement="left-start">
                    ...
                    @if ($work->status == 0)
                      <li><a class="dropdown-item border-radius-md" href="javascript:;" id="btnsave" data-order="{{ $work->order_id }}" data-status="delivering" data-assign="delivery">Deliver Now!</a></li>
                    @elseif($work->status == 1)
                      <li><a class="dropdown-item border-radius-md" href="javascript:;" id="btnsave" data-order="{{ $work->order_id }}" data-status="delivered" data-assign="delivery">Delivered!</a></li>
                    @endif
                  </ul>
                </div>
              </div>
